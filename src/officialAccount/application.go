...
import (
	...
	"github.com/uvlydxba56648/PowerWeChat/v3/src/basicService/media"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/basicService/qrCode"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/basicService/subscribeMessage"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/basicService/url"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/kernel"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/kernel/providers"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/auth"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/autoReply"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/base"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/broadcasting"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/card"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/comment"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/customerService"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/customerService/session"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/dataCube"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/device"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/goods"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/guide"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/material"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/menu"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/oauth"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/ocr"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/poi"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/publish"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/semantic"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/server"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/shakeAround"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/store"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/templateMessage"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/user"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/user/tag"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/officialAccount/wifi"
	"net/http"
)

...
import (
	...
	miniProgram2 "github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/accountService"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/accountService/customer"
	message3 "github.com/uvlydxba56648/PowerWeChat/v3/src/work/accountService/message"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/accountService/serviceState"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/accountService/servicer"
	tag3 "github.com/uvlydxba56648/PowerWeChat/v3/src/work/accountService/tag"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/agent"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/agent/workbench"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/auth"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/base"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/corpgroup"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/department"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/contactWay"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/customerAcquisition"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/customerStrategy"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/groupChat"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/groupWelcomeTemplate"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/messageTemplate"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/moment"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/momentStrategy"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/school"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/statistics"
	tag2 "github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/tag"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/externalContact/transfer"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/groupRobot"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/idConvert"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/invoice"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/jssdk"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/media"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/menu"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/message"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/message/appChat"
	externalContact2 "github.com/uvlydxba56648/PowerWeChat/v3/src/work/message/externalContact"
	linkedCorp2 "github.com/uvlydxba56648/PowerWeChat/v3/src/work/message/linkedCorp"
	miniProgram "github.com/uvlydxba56648/PowerWeChat/v3/src/work/miniProgram"
	msgaudit "github.com/uvlydxba56648/PowerWeChat/v3/src/work/msgAudit"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/approval"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/calendar"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/dial"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/journal"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/living"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/meeting"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/meetingroom"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/pstncc"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/schedule"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/wedoc"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oa/wedrive"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/oauth"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/server"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/user"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/user/batchJobs"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/user/exportJobs"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/user/linkedCorp"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/work/user/tag"
	"net/http"
)

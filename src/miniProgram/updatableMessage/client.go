...
import (
	...
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/updatableMessage/request"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/updatableMessage/response"
)

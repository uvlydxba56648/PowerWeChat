...
import (
	...
	"github.com/uvlydxba56648/PowerWeChat/v3/src/basicService/subscribeMessage"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/kernel"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/kernel/providers"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/auth"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/b2b"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/base"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/customerServiceMessage"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/dataCube"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/device"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/express"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/image"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/immediateDelivery"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/industry/miniDrama/vod"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/internet"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/liveBroadcast"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/nearbyPoi"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/nfcUrlLink"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/ocr"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/operation"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/phoneNumber"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/plugin"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/riskControl"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/search"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/security"
	server2 "github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/server"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/serviceMarket"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/shortLink"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/soter"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/uniformMessage"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/updatableMessage"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/urlLink"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/urlScheme"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/virtualPayment"
	wxaSecOrder "github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/wxa/sec/order"
	"github.com/uvlydxba56648/PowerWeChat/v3/src/miniProgram/wxaCode"
